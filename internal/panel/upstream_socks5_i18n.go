...
func init() {
	...
	messagesEN[Key("advanced.upstream.note")] = "Caspian first connects to this SOCKS5 server, then reaches your configured tunnel server through it. Client traffic still uses your selected tunnel. Clear both credential fields to use no authentication."
	...
	messagesFA[Key("advanced.upstream.note")] = "کاسپین ابتدا به این سرور SOCKS5 وصل می‌شود و سپس از طریق آن به سرور تونل تنظیم‌شده می‌رسد. ترافیک کاربران همچنان از تونل انتخاب‌شده عبور می‌کند. برای استفاده بدون احراز هویت، هر دو کادر نام کاربری و رمز عبور را خالی کنید."
